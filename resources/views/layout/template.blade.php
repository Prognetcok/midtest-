...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-primary" style="height: 60pt" style="color: white">
        <div class="container-fluid">
          <p class="nav-link mt-2" href="{{ route('Produks') }}" style="color: white">COKE STORE</p>
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav" style="padding-left: 150px">
              ...
              <a class="nav-link" href="{{ route('Produks') }}" style="color: white">Cards</a>
            </div>
          </div>
        </div>
      </nav>
